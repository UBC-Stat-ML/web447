...
### From a R Markdown document

To see an example of how to integrate Stan code inside R Markdown, see the source code used for the next page in the notes, [available on github](https://github.com/UBC-Stat-ML/web447/blob/main/w08_mcmc1/topic02_stan_basics.qmd).
