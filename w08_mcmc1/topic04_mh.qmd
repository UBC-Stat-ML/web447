...
**Demo:** Have a look at [this interactive animation](https://chi-feng.github.io/mcmc-demo/app.html?algorithm=RandomWalkMH&target=banana) showing MH on two-dimensional target (green arrow shows accepted proposal, red arrow, rejected).
...
- [Handbook on MCMC](https://www.mcmchandbook.net/) [Available online via UBC Library]
