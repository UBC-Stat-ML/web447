...
**Note:** there are more sophisticated methods for checking correctness of MCMC code, 
see for example:

- The *Exact Invariance Test* in 
[Bouchard-Côté et al., 2019](https://arxiv.org/abs/1912.10396), covered in more depth [later in this course](../w12_mcmc2/topic08_debug.qmd).
