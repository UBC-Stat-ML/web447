...
- Prior predictive checks: see [logistic regression lecture](../w04_glms/topic04_classification.qmd#prior-predictive), reinforced in this week's exercises.
...
workflow, but typical data analysis workflow practices should be used:
