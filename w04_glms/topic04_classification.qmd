...
- This is our first example of a Bayesian Generalized Linear Model (GLM). 
- GLMs are probably some of the most common models. 



## Example {#sec-data}

- The [Ariane 1](https://en.wikipedia.org/wiki/Ariane_1) is an expendable rocket 
launched 11 times between 1979 and 1986.
- It failed 2 times and was successful the other 9 launches. 
...
- This creates a problem when we feed the parameter to the Bernoulli, which expects a number between 0 and 1. 
:::
...
- Here is a peek of the posterior distribution you should obtain:
