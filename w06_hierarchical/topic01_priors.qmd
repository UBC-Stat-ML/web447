...
Selecting a prior for a parameter defined on $[0, 1]$, e.g. in the 
...
- First, pick a distribution **family** 
    - in our example: let us pick say Beta$(\cdot, \cdot)$, 
...
- Then, pick one member of this family  
    - e.g. Beta$(1, 2)$, but how to pick these "magic" numbers?
...
- "Informative priors": use expert knowledge
    ...
    - many techniques developed, see [Petrus et al, 2021](http://arxiv.org/abs/2112.01380) for a recent review,
...
The numbers to fill in the "?" are known as **hyper-parameters**, i.e., 
