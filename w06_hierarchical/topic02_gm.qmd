...
Graphical models help understanding complex models such as hierarchical models. 


## Directed graphical model

A graphical model is a discrete graph showing the dependencies involved in 
...
- the set of vertices is the set of random variables,
...
Directed graphical models are also useful to identify conditional independence relationships (recall, $A$ is conditionally independent of $B$ give $C$ if $\Pr(A|C) \Pr(B|C) = \Pr(A \cap B | C)$). 
