...
**By how much should I increase the number of iterations to get one more digit of accuracy?**
...
- vary the number of iterations ($10^1, 10^{1.5}, 10^2, 10^{2.5}, 10^3$),
    - for each number of iterations `n_iterations`, we run `simple_monte_carlo(n_iterations)` 500 times,
...
Based on this extra information, let's revisit our initial question:
