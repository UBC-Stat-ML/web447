...
PPLs are the main way you will compute posterior distributions in this course. 
...
Here is how to code up the "bag of coins" model in simPPLe for the purpose of computing $\pr(X = 1 | Y = (0, 0, 0, 0))$:
...
predict_next_flip <- function() {
  ...
  next_flip = simulate(Bern(prob_tails))
