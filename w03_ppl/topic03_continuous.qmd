...
<!-- 2026: I'm going over this page in office hour instead.. --> 
...
Since the parameters of distributions families are continuous, it is 
...
Today we will approach the calculations with both manual mathematical 
...
- I have a measuring tape, but you do not know how long it is.
  - Length of tape: $X$.
...
**Goal:** Can we guess (probabilistically) how many more humans there will ever be in total? 
