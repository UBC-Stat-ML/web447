...
**Goal here:** to gain some intuition on what is the notion of $\pi$-invariance, using an analogy. 
...
- Game:
    ...
    - Compute $x_4 = f(x_3)$
    - etc.
- Can we predict where $x_n$ will end up after an infinite number of iterations?
...
**Question:** what are the fixed points in this picture?

::: {.callout-caution collapse="true"} 
## Click for answer

The 3 yellow points. These are the points where the curve intersects the line $y = x$. 
:::
