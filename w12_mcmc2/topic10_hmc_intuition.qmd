...
- HMC at a high level: 
    1. **proposal**: from the current position, let the marble roll for time $t$ (approximately)
...
- a complicated kernel $\Kh$: "rolling the marble", combined with MH accept-reject which we will explore in more detail
