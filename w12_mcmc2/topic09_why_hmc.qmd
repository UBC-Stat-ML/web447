...
**Question:** is the time to compute one iteration (in e.g., seconds or [FLOPS](https://en.wikipedia.org/wiki/FLOPS)) a 
...
- optimally tuned random walk MH's cost (seconds/ESS) scales in $O(d^2)$. 

**Notes:** 

- This means that as $d$ increases, there is an increasing performance gap in favour of HMC.
