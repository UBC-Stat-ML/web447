...
Recall an example of credible interval we discussed: [quantile-based intervals](../w02_discrete_bayes/topic05_credible.qmd).
...
::: column-margin
![](../images/partition-with-A.png){width="100"}
:::
