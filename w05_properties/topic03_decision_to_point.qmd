...
We have seen [in week 2](../w02_discrete_bayes/topic04_point.qmd) some 
examples of point estimates (posterior mean, posterior mode). 
...
**Assume:** a *square loss,* $A = \reals$, $L(a, p) = (a - p)^2$.
