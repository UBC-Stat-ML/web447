...
As we have seen at the beginning one motivation for Bayesian methods is that 
...
Basic property that we expect from credible sets:
...
**Challenge:** implement a function taking as input a posterior PMF (as a vector), a level, and returns an HDI.
