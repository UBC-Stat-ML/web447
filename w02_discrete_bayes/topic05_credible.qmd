...
they allow us to quantify uncertainty in our predictions. Credible sets are 
...
- You are given a level, often $95\%$ or $90\%$, denoted $1-\alpha = 0.95$ or $1-\alpha = 0.9$
    - Intuition: we want to find a set $T$ such that we are $90\%$ sure that the true $x$ is in $T$. 
