...
- Decision theory: making decisions in the face of uncertainty. 
    - First, without observed data. 
    - Second, incorporating observed data.
- Review of properties of expectation useful for decision theory calculations.
...
- She flips a standard coin:
    - if it's a "tails": you give her \$10 
    - if it's a "heads": she gives you \$9. 
...
To do that simplification, first use **linearity of expectation** which you will recall from probability theory tells us that 
