...
The chain rule seems innocent but is used heavily in Bayesian statistics. 
...
We will often encounter expressions of the form of a conjunction (intersection/and) of several variables. 
...
**Definition:** $V$ and $W$ are conditionally independent given $Z$ if 
