...
Simple Monte Carlo is the foundation for more complex Monte Carlo methods used by Bayesian practitioners (e.g. Importance Sampling and Markov chain Monte Carlo (MCMC))
...
- In this case, instead of computing the exact expectation by iterating over each of the leaves as before, we will *approximate* expectations using forward simulation (a method known as **simple Monte Carlo**)
