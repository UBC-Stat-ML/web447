...
- "parameters block"
- "model block"
- ["transformed parameters block"](../w08_mcmc1/topic03_more_complex_example.qmd)
- ["generated quantities block"](../w08_mcmc1/topic06_hands_on.qmd)
...
- Central Limit Theorem (CLT) for Markov chains: writing the result formally and stating at least informally the conditions.
- Asymptotic variance
