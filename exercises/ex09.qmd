...
\begin{align*}
\mu_i &\sim \distUnif(0, 1), \text{ for }i \in \{1, 2\}, \expl{parameters for 2 clusters} \\
...
**Hint:** In the `forward` function, you should carefully handle synthetic data that 
are exactly equal to 0 or 5 to avoid issues with the evaluation of the Beta likelihood. For instance, you can include the code chunk inside 
