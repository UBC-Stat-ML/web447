...
3. The integral with $f(x) = \sin(\cos(\sin(x)))$ approximately evaluates to
$$
\int_0^1 f(x) \dee x \approx 0.7593064.
$$
Estimate its value using `mc_estimate(f)` and compare to the value given above.
