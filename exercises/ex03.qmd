...
step, we will construct a confidence interval[^1] for our Monte Carlo estimate
    ...
    b. Use the Central Limit Theorem to provide an asymptotically exact (as
       $K\to\infty$) confidence interval of level $\alpha=0.95$.
    
[^1]: Yes, the frequentist concept! Monte Carlo simulations are one of the few
      instances where the assumptions of frequentist inference hold by design.
