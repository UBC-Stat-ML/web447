...
\lambda_\text{e} &\sim \distExp(0.001) && (\text{diffuse prior})\\
\mu_\text{p} &\sim \distNamed{BetaMP}(0.1, 10) && (\text{incidence is usually low})\\
\lambda_\text{p} &\sim \distExp(0.001) && (\text{diffuse prior})\\
