...
pair.
2. Implement the model from part 1 in simPPLe. Your PPL function should return 
the indicator that Moderna is more effective than Pfizer.
3. Run your model using `posterior` (not `posterior_particles`) with the 
[provided data](ex06_assets/vaccines.csv) and report the estimated posterior
probability that Moderna is more effective than Pfizer.
